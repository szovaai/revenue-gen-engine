...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ClickAdMedia — Websites That Turn Clicks Into Customers" },
      {
        name: "description",
        content:
      ...
      { property: "og:site_name", content: "ClickAdMedia" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800;900&family=Space+Grotesk:wght@500;600;700&family=Space+Mono:wght@400;700&display=swap",
      },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "/",
          description:
            "Premium direct-response websites built to turn traffic into customers for local businesses.",
          founder: { "@type": "Person", name: "Jason R. Szova" },
        }),
      },
    ],
  }),
