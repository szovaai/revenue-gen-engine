  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          Ready to grow your <span className="text-gradient-brand">local business?</span>
        </h2>
        <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
          Book a free website review and we'll show you exactly how to turn more visitors into
          calls, leads, and booked jobs — starting at just $500, with no hidden fees.
        </p>
        <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            to="/website-examples"
            className="inline-flex h-14 items-center justify-center gap-2 rounded-full border border-border bg-secondary/40 px-8 text-base font-semibold text-foreground transition-colors hover:bg-secondary"
          >
