  ...
  return (
    <section className="relative border-t border-border py-20 md:py-28" aria-labelledby="cta-heading">
      ...
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          Ready to plug in your{" "}
          <span className="text-gradient-brand">Revenue Engine?</span>
        </h2>
        <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
          $0 setup. Limited pilot spots per city. Apply now and we'll let you know within one
          business day if your trade and territory are still open.
        </p>
